...
import Navutilidades from "../navherramientas/navfichas";
          ...
          <div className="p-5">
            ...
            <div className="flex">
              ...
              <label htmlFor="searchOption" className="ml-2 mr-4">
                Haga click aquí para mostrar{" "}
                <span className="font-bold">otras opciones de búsqueda </span>
              </label>
            </div>
            {showOptions && (
              <div>
        ...
        <div className="flex flex-row ml-20">
          <div className="p-5">
            <table>
              <thead>
                <tr>
                  <th className="border border-gray-300 bg-white p-2 w-5cw">
                    Código
                  </th>
                  <th className="border border-gray-300 bg-white p-2 w-5cw">
                    Teléfono
